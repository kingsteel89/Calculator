...
public class WechatPayActivity extends AppCompatActivity {
    ...
    public void onClickBtnPayment01(View view) {
        ...
        getPrepayId.execute();
        str_pay = getString(R.string.payed_btn_01);
    }

    public void onClickBtnPayment02(View view) {
        GetPrepayIdTask getPrepayId = new GetPrepayIdTask();
        getPrepayId.execute();
        str_pay = getString(R.string.payed_btn_02);
    }

    public void onClickBtnPayment03(View view) {
        GetPrepayIdTask getPrepayId = new GetPrepayIdTask();
        getPrepayId.execute();
        str_pay = getString(R.string.payed_btn_03);
    }

    public void onClickBtnPayment04(View view) {
        GetPrepayIdTask getPrepayId = new GetPrepayIdTask();
        getPrepayId.execute();
        str_pay = getString(R.string.payed_btn_04);
    }
