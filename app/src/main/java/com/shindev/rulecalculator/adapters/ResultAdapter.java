...
public class ResultAdapter  extends BaseAdapter {
    ...
    public ResultAdapter (Context context, ArrayList<String[]> datas, ArrayList<String[]> results) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (position == 0) {
            for (int i = 0; i < Global.gSelParams.size(); i++) {
                String value = Global.gSelParams.get(i).name;

                TextView textView = new TextView(mContext);
                textView.setText(value);
                textView.setTextColor(mContext.getColor(R.color.txt_black));
